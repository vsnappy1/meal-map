...
class GroceryListManagerImplTest {
    ...
    @Test
    fun markIngredientAsChecked_when_ingredient_is_not_in_list_should_add_it() =
        runTest(dispatcher) {
            // Given
            val ingredient =
    ...
    @Test
    fun markIngredientAsUnchecked_when_ingredient_is_in_list_should_remove_it() =
        runTest(dispatcher) {
            // Given
            val ingredient =
    ...
    @Test
    fun getCheckedGroceryIngredientsForWeek_should_return_list_of_checked_ingredients() =
        runTest(dispatcher) {
            // Given
    ...
    fun findMiddlePointOfWeek_should_return_wednesday_of_the_week() = runTest(dispatcher) {
        ...
        listOf<Long>(0, 1, 2).forEach { day -> // Saturday, Sunday, Monday
